...
- Test executable: `build/test/test_danp`
...
**Output:**
- Optimized library: `build/danp_project.a`
...
- **User install** (`~/.local`):
  - Libraries: `~/.local/lib/`
  - Headers: `~/.local/include/danp/`
  - CMake config: `~/.local/lib/cmake/danp/`

- **Custom prefix** (`/opt/mylibs`):
  - Libraries: `/opt/mylibs/lib/`
  - Headers: `/opt/mylibs/include/danp/`
  - CMake config: `/opt/mylibs/lib/cmake/danp/`
...
- Check test assertions in `test/test_danp.c`
