...
print_info "  - $BUILD_DIR/test/test_core"
print_info "  - $BUILD_DIR/test/test_dgram"
print_info "  - $BUILD_DIR/test/test_route"
print_info "  - $BUILD_DIR/test/test_stream"
print_info "  - $BUILD_DIR/test/test_zerocopy"
echo ""
