...
void test_packet_allocation_returns_different_packets(void)
{
    ...
    danp_packet_t *packet_1 = danp_alloc_packet();
    danp_packet_t *packet_2 = danp_alloc_packet();
    ...
    /* Cleanup */
    danp_free_packet(packet_1);
    danp_free_packet(packet_2);
}
